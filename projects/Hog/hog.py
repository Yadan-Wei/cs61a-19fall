...
def is_swap(player_score, opponent_score):
    ...
    def rightmost(score):
        return score % 10
    return leftmost(player_score)*rightmost(player_score) == leftmost(opponent_score)*rightmost(opponent_score)
    # END PROBLEM 4
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while max(score0,score1) < goal: 
        ...
        current_roll = current_strategy(current_score,opponent_score)
    
        current_score += take_turn(current_roll,opponent_score,dice)

        
        if abs(current_roll - pre_roll) == 2:
            current_score += 3
        
        if player == 0:
            score0 = current_score
            pre_roll0 = current_roll
        else:
            score1 = current_score
            pre_roll1 = current_roll
